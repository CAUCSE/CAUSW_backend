...
public enum AuthErrorCode implements BaseResponseCode {
	...
	BLOCKED_USER(HttpStatus.UNAUTHORIZED, "AUTH_401_005", "추방된 계정입니다. 재가입 문의는 caucsedongne@gmail.com으로 연락해주세요"),
	INACTIVE_USER(HttpStatus.UNAUTHORIZED, "AUTH_401_006", "탈퇴한 계정입니다. 계정 복구를 진행해주세요"),
	DELETED_USER(HttpStatus.UNAUTHORIZED, "AUTH_401_007", "삭제된 계정입니다. 회원가입 페이지에서 새로운 정보로 가입해주세요.");
