...
import net.causw.app.main.dto.userAcademicRecordApplication.CreateUserAcademicRecordApplicationRequestDto;
import net.causw.app.main.dto.userAcademicRecordApplication.CurrentUserAcademicRecordApplicationResponseDto;
import net.causw.app.main.dto.userAcademicRecordApplication.UpdateUserAcademicRecordApplicationStateRequestDto;
import net.causw.app.main.dto.userAcademicRecordApplication.UpdateUserAcademicStatusRequestDto;
...
public class UserAcademicRecordApplicationService {
	...
	public UserAcademicRecordApplicationResponseDto updateUserAcademicRecordApplicationStatus(
		...
		userAcademicRecordApplication.setAcademicRecordRequestStatus(
			updateUserAcademicRecordApplicationStateRequestDto.getTargetAcademicRecordRequestStatus());
		if (updateUserAcademicRecordApplicationStateRequestDto.getTargetAcademicRecordRequestStatus()
			.equals(AcademicRecordRequestStatus.REJECT)) {
			userAcademicRecordApplication.setRejectMessage(
				updateUserAcademicRecordApplicationStateRequestDto.getRejectMessage());
		}

		if (updateUserAcademicRecordApplicationStateRequestDto.getTargetAcademicRecordRequestStatus()
			.equals(AcademicRecordRequestStatus.ACCEPT)) {
	...
	public UserAcademicRecordApplicationResponseDto createUserAcademicRecordApplication(
		...
		List<UserAcademicRecordApplication> awaitUserAcademicRecordApplicationList = this.getAwaitUserAcademicRecordApplicationList(
			user);
		...
		if (createUserAcademicRecordApplicationRequestDto.getTargetAcademicStatus().equals(AcademicStatus.ENROLLED)) {
			...
			if (createUserAcademicRecordApplicationRequestDto.getTargetAcademicStatus()
	...
	private List<UserAcademicRecordApplication> getAwaitUserAcademicRecordApplicationList(User user) {
		return userAcademicRecordApplicationRepository.findByUserAndAcademicRecordRequestStatus(user,
			AcademicRecordRequestStatus.AWAIT);
	}
