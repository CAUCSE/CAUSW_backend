...
public class GoogleMailSender {
	...
	public void sendNewPasswordMail(
		...
		String content =
			"<div style=\"font-family: Arial, sans-serif; font-size: 16px; color: #333333; background-color: #f9f9f9; padding: 20px; border: 1px solid #dddddd; border-radius: 5px; max-width: 600px; margin: 0 auto;\">"
