...
public interface CircleDtoMapper extends UuidFileToUrlDtoMapper {
	...
	BoardOfCircleResponseDto toBoardOfCircleResponseDtoExtended(Board board, Boolean writeable, Post post,
		Long postNumComment);

	CircleBoardsResponseDto toCircleBoardsResponseDto(CircleResponseDto circle,
		List<BoardOfCircleResponseDto> boardList);

	@Mapping(target = "id", source = "board.id")
	CircleMemberResponseDto toCircleMemberResponseDto(CircleMember board, CircleResponseDto circle,
