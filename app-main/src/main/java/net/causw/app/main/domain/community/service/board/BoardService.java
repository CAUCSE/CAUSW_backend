package net.causw.app.main.domain.community.service.board;
...
import net.causw.app.main.domain.community.entity.board.BoardApplyStatus;
import net.causw.app.main.domain.community.event.board.BoardApplyRepository;
...
import net.causw.app.main.domain.community.service.post.PostEntityService;
...
import net.causw.app.main.domain.moving.dto.board.BoardNameCheckRequestDto;
import net.causw.app.main.domain.moving.dto.board.BoardNameCheckResponseDto;
				...
				List<PostContentDto> recentPosts = postEntityService.findPostsByBoardWithFilters(
					...
					.map(post -> {
						...
						postContentDto.setDisplayWriterNickname(
							postService.getDisplayWriterNickname(writer, postContentDto.getIsAnonymous(),
