...
public class SocialNativeAuthService {
	 ...
	 */
	@Transactional
	public SignInResult login(String provider, String accessToken, String idToken, String authorizationCode,
		String redirectUri, String codeVerifier, boolean isKeepLogin) {
