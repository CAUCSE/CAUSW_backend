...
import net.causw.app.main.dto.userCouncilFee.CreateUserCouncilFeeWithFakeUserRequestDto;
import net.causw.app.main.dto.userCouncilFee.CreateUserCouncilFeeWithUserRequestDto;
...
public class UserCouncilFeeService {
	...
	public void exportUserCouncilFeeToExcel(HttpServletResponse response) {
		...
		String fileName =
			semester.getSemesterYear().toString() + "-" + semester.getSemesterType().getValue() + "_학생회비_납부자_현황";
	...
	@Transactional
	public void createUserCouncilFeeWithUser(User user,
		...
		if (userCouncilFeeRepository.existsByUser(targetUser)) {
			throw new BadRequestException(ErrorCode.INVALID_PARAMETER,
				MessageUtil.USER_COUNCIL_FEE_INFO_ALREADY_EXISTS);
		}

		if (targetUser.getCurrentCompletedSemester() == null) {
			throw new BadRequestException(ErrorCode.ROW_DOES_NOT_EXIST,
				MessageUtil.USER_CURRENT_COMPLETE_SEMESTER_DOES_NOT_EXIST);
		}

		if (createUserCouncilFeeWithUserRequestDto.getIsRefunded()
			&& createUserCouncilFeeWithUserRequestDto.getRefundedAt() == null) {
		...
		UserCouncilFee userCouncilFee = UserCouncilFee.of(
			...
			createUserCouncilFeeWithUserRequestDto.getRefundedAt() == null ? null :
	...
	@Transactional
	public void creatUserCouncilFeeWithFakeUser(User user,
	...
	@Transactional
	public void updateUserCouncilFeeWithUser(User user, String userCouncilFeeId,
		CreateUserCouncilFeeWithUserRequestDto createUserCouncilFeeWithUserRequestDto) {
		User controlledUser = userRepository.findById(user.getId())
			.orElseThrow(() -> new BadRequestException(ErrorCode.ROW_DOES_NOT_EXIST, MessageUtil.USER_NOT_FOUND));
		...
		UserCouncilFee userCouncilFee = userCouncilFeeRepository.findById(userCouncilFeeId)
			.orElseThrow(
				() -> new BadRequestException(ErrorCode.ROW_DOES_NOT_EXIST, MessageUtil.USER_COUNCIL_FEE_NOT_FOUND));
	...
	@Transactional
	public void updateUserCouncilFeeWithFakeUser(User user, String userCouncilFeeId,
		CreateUserCouncilFeeWithFakeUserRequestDto createUserCouncilFeeWithFakeUserRequestDto) {
		User controlledUser = userRepository.findById(user.getId())
			.orElseThrow(() -> new BadRequestException(ErrorCode.ROW_DOES_NOT_EXIST, MessageUtil.USER_NOT_FOUND));
	...
	private UserCouncilFeeListResponseDto toUserCouncilFeeListResponseDtoReduced(UserCouncilFee userCouncilFee,
		CouncilFeeFakeUser councilFeeFakeUser) {
		return UserCouncilFeeDtoMapper.INSTANCE.toUserCouncilFeeListResponseDtoReduced(userCouncilFee,
			councilFeeFakeUser);
	}
	...
	private CurrentUserCouncilFeeResponseDto toCurrentUserCouncilFeeResponseDto(UserCouncilFee userCouncilFee,
		Integer restOfSemester, Boolean isAppliedThisSemester) {
		return UserCouncilFeeDtoMapper.INSTANCE.toCurrentUserCouncilFeeResponseDto(userCouncilFee, restOfSemester,
