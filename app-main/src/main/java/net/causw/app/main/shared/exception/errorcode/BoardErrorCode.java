...
public enum BoardErrorCode implements BaseResponseCode {
	...
	BOARD_SYSTEM_NOTICE_NOT_MODIFIABLE(HttpStatus.FORBIDDEN, "BOARD_403_002", "시스템 공지 게시판은 삭제하거나 변경할 수 없습니다"),
	BOARD_SYSTEM_NOTICE_NOT_UNIQUE(HttpStatus.INTERNAL_SERVER_ERROR, "BOARD_500_001", "시스템 공지 게시판이 둘 이상 존재합니다"),
	BOARD_DELETED(HttpStatus.BAD_REQUEST, "BOARD_400_002", "삭제된 게시판입니다."),
	BOARD_NOTICE_CANNOT_BE_ANONYMOUS(HttpStatus.BAD_REQUEST, "BOARD_400_003", "공지 게시판은 익명을 허용할 수 없습니다.");
