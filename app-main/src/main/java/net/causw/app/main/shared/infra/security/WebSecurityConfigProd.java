package net.causw.app.main.shared.infra.security;
...
public class WebSecurityConfigProd {
	...
	public WebSecurityConfigProd(JwtTokenProvider jwtTokenProvider,
		CustomAuthenticationEntryPoint jwtAuthenticationEntryPoint) {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
			...
			.exceptionHandling(
				exceptionHandling -> exceptionHandling.authenticationEntryPoint(this.customAuthenticationEntryPoint))
			.sessionManagement(
