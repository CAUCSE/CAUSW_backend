package net.causw.app.main.domain.community.form.service.v1;
...
import net.causw.app.main.domain.community.form.api.v1.dto.request.QuestionReplyRequestDto;
...
import net.causw.app.main.domain.community.form.api.v1.dto.response.OptionSummaryResponseDto;
...
import net.causw.app.main.domain.community.form.api.v1.dto.response.reply.ReplyQuestionResponseDto;
import net.causw.app.main.domain.community.form.api.v1.dto.response.reply.ReplyResponseDto;
import net.causw.app.main.domain.community.form.api.v1.dto.response.reply.ReplyUserResponseDto;
...
import net.causw.app.main.domain.community.form.repository.OptionRepository;
import net.causw.app.main.domain.community.form.repository.QuestionRepository;
import net.causw.app.main.domain.community.form.repository.ReplyQuestionRepository;
...
import net.causw.app.main.domain.integration.export.service.v1.FormExcelService;
...
public class FormService {
	...
	private ReplyResponseDto toReplyResponseDto(User user, List<ReplyQuestionResponseDto> replyQuestionResponseDtoList,
	...
	private ReplyUserResponseDto toReplyUserResponseDto(User user) {
		...
		return FormDtoMapper.INSTANCE.toReplyUserResponseDto(user, userCouncilFee, isAppliedThisSemester,
			restOfSemester);
	}
			...
			List<OptionSummaryResponseDto> answerList = formQuestion.getFormQuestionOptionList().stream()
				.map(formQuestionOption -> {
					Long selectedCount = replyQuestionList
						.stream()
						.filter(replyQuestion -> replyQuestion.getSelectedOptionList()
							.contains(formQuestionOption.getNumber()))
						.count();
	...
	public List<UserReplyResponseDto> getReplyByUserAndCircle(String userId, String circleId) {
		List<Form> circleFormList = this.formRepository.findAllByCircleAndIsDeletedAndIsClosed(this.getCircle(circleId),
			false, false);
