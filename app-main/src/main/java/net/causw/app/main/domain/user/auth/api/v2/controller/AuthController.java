...
public class AuthController {
	...
	public ResponseEntity<ApiResponse<AuthResponse>> loginNativeSocial(
		...
		SignInResult dto = socialNativeAuthService.login(request.provider(), request.accessToken(), request.idToken(),
			request.authorizationCode(), request.redirectUri(), request.codeVerifier(), request.isKeepLogin());
		return createAuthResponse(dto);
	}
