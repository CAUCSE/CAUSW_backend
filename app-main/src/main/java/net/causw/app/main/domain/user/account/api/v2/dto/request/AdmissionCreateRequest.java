...
public record AdmissionCreateRequest(
	...
	@Schema(description = "이름", example = "홍길동") @NotBlank(message = "이름을 입력해 주세요.") String name,
	...
	@Schema(description = "학번", example = "20210001") @NotBlank(message = "학번을 입력해 주세요.") String requestedStudentId,
	...
	@Schema(description = "증빙설명", example = "재학증명서입니다.") String description) {
}
