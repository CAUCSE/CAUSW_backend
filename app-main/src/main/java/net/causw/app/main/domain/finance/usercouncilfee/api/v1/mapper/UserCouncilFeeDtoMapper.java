package net.causw.app.main.domain.finance.usercouncilfee.api.v1.mapper;
...
public interface UserCouncilFeeDtoMapper {
	...
	UserCouncilFeeListResponseDto toUserCouncilFeeListResponseDtoReduced(UserCouncilFee userCouncilFee,
	...
	UserCouncilFeeResponseDto toUserCouncilFeeResponseDto(UserCouncilFee userCouncilFee, User user,
	...
	@Mapping(target = "restOfSemester", source = "restOfSemester")
	@Mapping(target = "isAppliedThisSemester", source = "isAppliedThisSemester")
	UserCouncilFeeResponseDto toUserCouncilFeeResponseDtoReduced(UserCouncilFee userCouncilFee,
		CouncilFeeFakeUser councilFeeFakeUser, Integer restOfSemester, Boolean isAppliedThisSemester);

	@Mapping(target = "isRefunded", source = "userCouncilFee.isRefunded")
	@Mapping(target = "numOfPaidSemester", source = "userCouncilFee.numOfPaidSemester")
	@Mapping(target = "isAppliedThisSemester", source = "isAppliedThisSemester")
	@Mapping(target = "restOfSemester", source = "restOfSemester")
	CurrentUserCouncilFeeResponseDto toCurrentUserCouncilFeeResponseDto(UserCouncilFee userCouncilFee,
		Integer restOfSemester, Boolean isAppliedThisSemester);
}
