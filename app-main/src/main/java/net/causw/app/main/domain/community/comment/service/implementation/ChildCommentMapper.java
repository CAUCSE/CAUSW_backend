...
/**
 * 답글 {@link Comment} 엔티티를 {@link CommentResult} 응답 객체로 변환합니다.
 *
...
public class ChildCommentMapper {
	...
	/**
	 * 대댓글 엔티티와 렌더 데이터를 조합하여 {@link CommentResult}를 생성합니다.
	 *
	...
	/**
	 * 대댓글 렌더링에 필요한 개별 값을 받아 {@link CommentResult}를 생성하는 편의 메서드.
	 *
