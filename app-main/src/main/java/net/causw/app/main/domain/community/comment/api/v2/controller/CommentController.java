...
public class CommentController {
	...
	public Page<CommentResponseDto> findAllComments(
		...
		return commentService.findAllComments(userDetails.getUser().getId(), postId, pageNum);
	}
	...
	public CommentResponseDto createComment(
		...
		@AuthenticationPrincipal CustomUserDetails userDetails) {
		return commentService.createComment(userDetails.getUser().getId(), commentCreateRequestDto);
	}
	...
	public CommentResponseDto deleteComment(
		@PathVariable("id") String id,
		@AuthenticationPrincipal CustomUserDetails userDetails) {
		return commentService.deleteComment(userDetails.getUser().getId(), id);
	}
