...
import net.causw.app.main.domain.moving.model.entity.comment.LikeChildComment;
...
import net.causw.app.main.domain.moving.repository.comment.LikeChildCommentRepository;
...
import net.causw.app.main.domain.moving.dto.comment.ChildCommentCreateRequestDto;
...
public class ChildCommentService {
	...
	public ChildCommentResponseDto deleteChildComment(User deleter, String childCommentId) {
		...
		validatorBucket.consistOf(
			TargetIsDeletedValidator.of(childComment.getIsDeleted(), StaticValue.DOMAIN_CHILD_COMMENT));
