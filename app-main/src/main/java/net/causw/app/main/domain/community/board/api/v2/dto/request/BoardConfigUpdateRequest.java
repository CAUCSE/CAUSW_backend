...
public record BoardConfigUpdateRequest(
	@Schema(description = "게시판 고유 아이디", example = "b9eb8761-1cfe-4742-a2bd-25dd7de68e25") @NotBlank String boardId,
	...
	@Schema(description = "노출 대상 학과 목록 (빈 배열이면 전체 학과)", example = "[\"SCHOOL_OF_SW\", \"DEPT_OF_AI\"]") Set<Department> departments) {
}
