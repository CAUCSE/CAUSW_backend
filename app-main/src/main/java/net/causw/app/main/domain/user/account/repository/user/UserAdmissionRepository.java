...
public interface UserAdmissionRepository extends JpaRepository<UserAdmission, String> {
	...
	Page<UserAdmission> findAll(@Param("user_state")
	String userState, Pageable pageable);
	...
	Page<UserAdmission> findAllWithStateAneName(@Param("user_state")
	String userState, @Param("name")
	String name,
		Pageable pageable);

	@NotNull
	Page<UserAdmission> findAll(@NotNull
	Pageable pageable);
