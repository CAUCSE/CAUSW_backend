...
import net.causw.app.main.dto.board.BoardNameCheckRequestDto;
...
import net.causw.app.main.dto.board.NormalBoardApplyRequestDto;
...
public class BoardService {
	...
	public List<BoardMainResponseDto> mainBoard(
		...
		return boards.stream()
			.map(board -> {
				List<PostContentDto> recentPosts = postRepository.findTop3ByBoard_IdAndIsDeletedOrderByCreatedAtDesc(
						board.getId(), false).stream()
	...
	public void applyNormalBoard(
		...
		Circle circle =
			(normalBoardApplyRequestDto.getCircleId() == null || normalBoardApplyRequestDto.getCircleId().isEmpty()) ?
				null :
