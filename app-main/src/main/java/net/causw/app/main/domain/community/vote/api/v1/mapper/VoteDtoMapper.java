package net.causw.app.main.domain.community.vote.api.v1.mapper;
...
public interface VoteDtoMapper {
	...
	VoteResponseDto toVoteResponseDto(Vote vote, List<VoteOptionResponseDto> options, boolean isOwner, boolean isEnd,
		boolean hasVoted, Integer totalVoteCount, Integer totalUserCount);
	...
	VoteOptionResponseDto toVoteOptionResponseDto(VoteOption voteOption, Integer voteCount,
		List<UserResponseDto> voteUsers);
}
