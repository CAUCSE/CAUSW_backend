...
import net.causw.app.main.domain.moving.dto.locker.LockerLocationCreateRequestDto;
import net.causw.app.main.domain.moving.dto.locker.LockerLocationResponseDto;
import net.causw.app.main.domain.moving.dto.locker.LockerLocationUpdateRequestDto;
import net.causw.app.main.domain.moving.dto.locker.LockerLocationsResponseDto;
import net.causw.app.main.domain.moving.dto.locker.LockerLogResponseDto;
import net.causw.app.main.domain.moving.dto.locker.LockerMoveRequestDto;
import net.causw.app.main.domain.moving.dto.locker.LockerRegisterPeriodRequestDto;
...
import net.causw.app.main.domain.moving.model.entity.locker.LockerName;
...
import net.causw.app.main.domain.moving.repository.locker.LockerLocationRepository;
...
import net.causw.app.main.domain.moving.validation.LockerExpiredAtValidator;
...
public class LockerService {
	...
	public LockerResponseDto create(
		...
		lockerLogRepository.save(
			LockerLog.of(locker.getLockerNumber(), lockerLocation.getName(), user.getEmail(), user.getName(),
	...
	public LockerResponseDto delete(User user, String lockerId) {
		...
		LockerLog lockerLog = LockerLog.of(locker.getLockerNumber(), locker.getLocation().getName(), user.getEmail(),
			user.getName(), LockerLogAction.DISABLE,
	...
	public void setRegisterPeriod(
		...
		// 신청 시작일 < 신청 종료일 체크
		if (!lockerRegisterPeriodRequestDto.getRegisterStartAt()
		...
		// 신청 시작일 설정
		setOrUpdateTextField(StaticValue.REGISTER_START_AT,
	...
	private void createLockerByLockerLocationAndEndLockerNumber(LockerLocation lockerLocationSecondFloor,
		ValidatorBucket validatorBucket, User user, Long endNum) {
