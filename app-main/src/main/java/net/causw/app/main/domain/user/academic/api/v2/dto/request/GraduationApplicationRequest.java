...
public record GraduationApplicationRequest(
	@Schema(description = "졸업년도", example = "2026", requiredMode = Schema.RequiredMode.REQUIRED) @NotNull(message = "졸업년도는 필수입니다.") @Min(value = 1950, message = "올바른 네 자리 연도를 입력해 주세요.") @Max(value = 2200, message = "올바른 네 자리 연도를 입력해 주세요.") Integer graduationYear,
