package net.causw.app.main.infrastructure.redis.uuidFile;
...
public class CleanUnusedUuidFileRedisService {
	...
	public void setPageNumData(String tableName, Integer pageNum, Long expiredTime) {
		...
		cleanUnusedUuidFileRedisTemplate.opsForValue()
			.set(redisKey, String.valueOf(pageNum), expiredTime, TimeUnit.MILLISECONDS);
	}
