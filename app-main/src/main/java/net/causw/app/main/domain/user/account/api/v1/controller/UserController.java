package net.causw.app.main.domain.user.account.api.v1.controller;
...
import net.causw.app.main.domain.user.account.api.v1.dto.UserAdmissionCreateRequestDto;
...
import net.causw.app.main.domain.user.account.api.v1.dto.UserCommentsResponseDto;
import net.causw.app.main.domain.user.account.api.v1.dto.UserCreateRequestDto;
import net.causw.app.main.domain.user.account.api.v1.dto.UserFcmCreateRequestDto;
import net.causw.app.main.domain.user.account.api.v1.dto.UserFcmTokenResponseDto;
import net.causw.app.main.domain.user.account.api.v1.dto.UserFindIdRequestDto;
import net.causw.app.main.domain.user.account.api.v1.dto.UserFindIdResponseDto;
import net.causw.app.main.domain.user.account.api.v1.dto.UserFindPasswordRequestDto;
import net.causw.app.main.domain.user.account.api.v1.dto.UserPostsResponseDto;
import net.causw.app.main.domain.user.account.api.v1.dto.UserPrivilegedResponseDto;
import net.causw.app.main.domain.user.account.api.v1.dto.UserRecoverRequestDto;
import net.causw.app.main.domain.user.account.api.v1.dto.UserResponseDto;
import net.causw.app.main.domain.user.account.api.v1.dto.UserSignInRequestDto;
import net.causw.app.main.domain.user.account.api.v1.dto.UserSignInResponseDto;
import net.causw.app.main.domain.user.account.api.v1.dto.UserSignOutRequestDto;
import net.causw.app.main.domain.user.account.api.v1.dto.UserSignOutResponseDto;
import net.causw.app.main.domain.user.account.api.v1.dto.UserUpdatePasswordRequestDto;
...
public class UserController {
	...
	@ApiResponses({
		...
		@ApiResponse(responseCode = "4103", description = "탈퇴한 사용자 입니다.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UnauthorizedException.class))),
	...
	@ApiResponses({
		...
		@ApiResponse(responseCode = "4102", description = "추방된 사용자 입니다.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BadRequestException.class))),
		@ApiResponse(responseCode = "4103", description = "탈퇴한 사용자 입니다.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BadRequestException.class))),
	...
	@ResponseStatus(value = HttpStatus.OK)
	@Operation(summary = "탈퇴 사용자 계정 복구 API", description = "탈퇴한 계정을 복구하여 ACTIVE 상태로 변경하고 로그인 토큰을 발급합니다.")
	@ApiResponses({
		@ApiResponse(responseCode = "200", description = "OK", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UserSignInResponseDto.class))),
		@ApiResponse(responseCode = "4000", description = "해당 사용자를 찾을 수 없습니다", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BadRequestException.class))),
	...
	@ApiResponses({
		...
		@ApiResponse(responseCode = "4103", description = "탈퇴한 사용자 입니다.", content = @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json", schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = BadRequestException.class))),
