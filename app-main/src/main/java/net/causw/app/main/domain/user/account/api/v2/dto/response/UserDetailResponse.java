...
public record UserDetailResponse(
	...
	@Schema(description = "이메일", example = "yebin@cau.ac.kr") String email,

	@Schema(description = "이름", example = "이예빈") String name,

	@Schema(description = "학번", example = "20209999") String studentId,
	...
	@Schema(description = "소속 학부", example = "SCHOOL_OF_SW") Department department,
	...
	@Schema(description = "거절 또는 탈퇴 사유", example = "재학 증빙 서류 미제출", nullable = true) String rejectionOrDropReason,

	@Schema(description = "계정 생성일시", example = "2024-03-24T10:15:30") LocalDateTime createdAt,

	@Schema(description = "계정 정보 수정일시", example = "2024-08-24T18:42:10") LocalDateTime updatedAt) {
}
