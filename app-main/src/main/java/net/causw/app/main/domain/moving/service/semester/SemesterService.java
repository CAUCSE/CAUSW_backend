package net.causw.app.main.domain.moving.service.semester;
...
import net.causw.app.main.domain.moving.repository.semester.SemesterRepository;
...
import net.causw.app.main.domain.user.repository.userCouncilFee.CouncilFeeFakeUserRepository;
