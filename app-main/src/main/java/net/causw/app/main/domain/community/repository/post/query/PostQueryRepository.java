package net.causw.app.main.domain.community.repository.post.query;
...
import net.causw.app.main.domain.community.entity.comment.QComment;
import net.causw.app.main.domain.community.entity.post.QFavoritePost;
import net.causw.app.main.domain.community.entity.post.QLikePost;
