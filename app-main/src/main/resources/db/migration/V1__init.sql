...
(
    ...
    UNIQUE INDEX `UK_5n4i9ncqv3c3ns9tunyxq1vww`
(
    `name`
    ASC
) VISIBLE)
...
(
    ...
    UNIQUE INDEX `UK_kfx69bjr0mcgnwsluuohuvhpb`
(
    `user_id`
    ASC
) VISIBLE,
    INDEX `FKdkeceafnif5f6kji4f0kmie6n`
(
    `location_id`
    ASC
) VISIBLE,
...
(
    ...
    `rejection_or_drop_reason` VARCHAR
(
    255
) NULL DEFAULT NULL,
    `state` ENUM
...
(
    ...
    UNIQUE INDEX `UK_4vih17mube9j7cqyjlfbcrk4m`
(
    `email`
    ASC
) VISIBLE,
    UNIQUE INDEX `UK_ig0bbysxr6nnpxo4qn2btdcc8`
(
    `nickname`
    ASC
) VISIBLE,
    UNIQUE INDEX `UK_qi5yr54j76lu2meatpwefocym`
(
    `phone_number`
    ASC
) VISIBLE,
    UNIQUE INDEX `UK_djjmuep18k7xs81lgqgutfhjd`
(
    `student_id`
    ASC
) VISIBLE,
    UNIQUE INDEX `UK_6md40q5ok3w1xs4ugdds0kcx2`
(
    `locker_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FK68hi5kpp95tb3qu6fcfxq7fa7`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `UK_faag85xipb292m553obdly74p`
(
    `leader_id`
    ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `UK_79ufcd1db5uudn8hf4tg00s5t`
(
    `name`
    ASC
) VISIBLE,
    INDEX `FKf56nd4y1y3jqyec9a19gl4i43`
(
    `circle_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FKde6dcpov54bln9k8pm0eo02wj`
(
    `user_id`
    ASC
) VISIBLE,
    INDEX `FK77llxkuuxhgumf8kjvl5yi9xx`
(
    `circle_id`
    ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `UK_ok1ekub9dpdyhsx9vexnkn1sn`
(
    `file_key`
    ASC
) VISIBLE,
    UNIQUE INDEX `UK_o61trieqgmab71n786b9aic93`
(
    `uuid`
    ASC
) VISIBLE)
...
(
    ...
    UNIQUE INDEX `UK_ovufeprpl55xmb2xrw2i8itku`
(
    `calendar_id`
    ASC
) VISIBLE,
    UNIQUE INDEX `UK_s2koor1hv4d06sf3ui0r5rlte`
(
    `uuid_file_id`
    ASC
) VISIBLE,
    INDEX `idx_calendar_attach_image_calendar_id`
(
    `calendar_id`
    ASC
) VISIBLE,
    INDEX `idx_calendar_attach_image_uuid_file_id`
(
    `uuid_file_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FK1r9gjgpwdqf6rxp0i9l8k3qgo`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `UK_iqegoxxctvtkjkrm2ge33j26d`
(
    `uuid_file_id`
    ASC
) VISIBLE,
    INDEX `idx_ceremony_attach_image_ceremony_id`
(
    `ceremony_id`
    ASC
) VISIBLE,
    INDEX `idx_ceremony_attach_image_uuid_file_id`
(
    `uuid_file_id`
    ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `UK_dc7o4ac8ym4ar2q5t4ld863py`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FK36lyx1t3etyvq6gloftmklrt3`
(
    `notification_id`
    ASC
) VISIBLE,
...
(
    ...
    REFERENCES `tb_ceremony_push_notification`
(
    `id`
))
    ENGINE = InnoDB
...
(
    ...
    `enrolled_registered_semester` VARCHAR
(
    255
) NULL DEFAULT NULL,
    `leave_of_absence_registered_semester` VARCHAR
(
    255
) NULL DEFAULT NULL,
    `form_type` ENUM
(
    ...
    `is_allowed_enrolled` BIT
(
    1
) NOT NULL,
    `is_allowed_graduation` BIT
(
    1
) NOT NULL,
    `is_allowed_leave_of_absence` BIT
(
    1
) NOT NULL,
    `is_closed` BIT
...
(
    ...
    UNIQUE INDEX `UK_enof2bygn1xgrpr4mwie0w2j`
(
    `form_id`
    ASC
) VISIBLE,
    UNIQUE INDEX `UK_l5mhtqwocn13ic8vaiqor2rv1`
(
    `vote_id`
    ASC
) VISIBLE,
    INDEX `board_id_index`
(
    `board_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FKebak8c8m45519djplq0wanuj3`
(
    `post_id`
    ASC
) VISIBLE,
    INDEX `FK45c1cuqlljd60ihc9j0962ekq`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FKss4sg42rfphnmx0vdx1w98y4k`
(
    `parent_comment_id`
    ASC
) VISIBLE,
    INDEX `FKj32wiafix4hn1gg1u5t8h5n56`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `UK_qcir89lvmcchytkp3wrrb8a2j`
(
    `circle_id`
    ASC
) VISIBLE,
    UNIQUE INDEX `UK_jkn26qkltriq62ncsjmhxw4b4`
(
    `uuid_file_id`
    ASC
) VISIBLE,
    INDEX `idx_circle_main_image_circle_id`
(
    `circle_id`
    ASC
) VISIBLE,
    INDEX `idx_circle_main_image_uuid_file_id`
(
    `uuid_file_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FKbo9i5g84h1g2l027f5hw3jlxx`
(
    `form_id`
    ASC
) VISIBLE,
    INDEX `FKkjv6in4jhfr484po2uqetymy9`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `UK_d2iivsfp5em6yjwl34r0ra2b2`
(
    `form_id`
    ASC
) VISIBLE,
    UNIQUE INDEX `UK_44wac575y755n0h69u0jt59ns`
(
    `reply_id`
    ASC
) VISIBLE,
    INDEX `FKawtp1h56vah8jiddihqpgx5rd`
(
    `circle_id`
    ASC
) VISIBLE,
    INDEX `FKdij2o1r9y352dl3vhkqt79sww`
(
    `user_id`
    ASC
) VISIBLE,
    INDEX `FKrt9v3qda9jgpjlnbwstaxwp0k`
(
    `user_circle_id`
    ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `UK_5jsgsfwrca8bepsku2i3rjosl`
(
    `link`
    ASC
) VISIBLE)
...
(
    ...
    INDEX `FK3gwbq5o1qaosqlaimu5ci73by`
(
    `crawled_notice_id`
    ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `UK_7a78e300gosbeltnmmwu0h0me`
(
    `event_id`
    ASC
) VISIBLE,
    UNIQUE INDEX `UK_3uqg1t4dny9705he4cybg1wlq`
(
    `uuid_file_id`
    ASC
) VISIBLE,
    INDEX `idx_event_attach_image_event_id`
(
    `event_id`
    ASC
) VISIBLE,
    INDEX `idx_event_attach_image_uuid_file_id`
(
    `uuid_file_id`
    ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `UK_h1hd4vvc3s6wuleh5p8bbw95b`
(
    `board_id`
    ASC
) VISIBLE,
    UNIQUE INDEX `UK_93xmc4i6k8aupicijs54boo7k`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FKqavkdq0v03v53woarf9k8jb3e`
(
    `post_id`
    ASC
) VISIBLE,
    INDEX `FKq8b00gpymgb124dqmlt5vpf39`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `UK_9mxdy90sn6d8r6ri8dfudruhr`
(
    `tb_key`
    ASC
) VISIBLE)
...
(
    ...
    INDEX `FKlkre2tncjdw7t8mq5x9onalme`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FKpcfrmcqr6j5p96w4o6ekg5v84`
(
    `child_comment_id`
    ASC
) VISIBLE,
    INDEX `FK917vru5uo96cg0cppqolnm218`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FKf0cu0ei1kpmat8xvl7rwm1urv`
(
    `comment_id`
    ASC
) VISIBLE,
    INDEX `FK32g6rm8jtugo3ve18bss452ek`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FK73pv6iorxfcdvctu0mpg206x8`
(
    `post_id`
    ASC
) VISIBLE,
    INDEX `FK713sod6n69tcbtxpeq1pqpds5`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    `target_parent_id` VARCHAR
(
    255
) NULL DEFAULT NULL, # 임시 조치
(
    추후
    삭제
)
...
(
    ...
    INDEX `FK9ihj3k9lv33u6qd10wq18f482`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FKnm0qj8np5hpys0e9rfe4jlu3b`
(
    `notification_id`
    ASC
) VISIBLE,
    INDEX `FKl2q98bs3s4gdkf77nfntwbgyk`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `UK_dec6rw0gbb32hu2bgvoygrhql`
(
    `uuid_file_id`
    ASC
) VISIBLE,
    INDEX `idx_post_attach_image_post_id`
(
    `post_id`
    ASC
) VISIBLE,
    INDEX `idx_post_attach_image_uuid_file_id`
(
    `uuid_file_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FK1f7qdbcou7kki27na1yhgn4a5`
(
    `update_user_id`
    ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `UK_1jym6b281dx706drcf9gbc8iw`
(
    `tb_key`
    ASC
) VISIBLE)
...
(
    ...
    `academic_record_request_status` ENUM
(
    'ACCEPT',
    'REJECT',
    'AWAIT',
...
(
    ...
    `user_academic_record_application_id` VARCHAR
(
    255
) NOT NULL,
    `uuid_file_id` VARCHAR
...
(
    ...
    UNIQUE INDEX `UK_m5oic5hwkfi8a67wp49s3qdn0`
(
    `uuid_file_id`
    ASC
) VISIBLE,
    INDEX `idx_user_academic_record_application_attach_image_application_id`
(
    `user_academic_record_application_id`
    ASC
) VISIBLE,
    INDEX `idx_user_academic_record_application_attach_image_uuid_file_id`
(
    `uuid_file_id`
    ASC
) VISIBLE,
...
(
    ...
    REFERENCES `tb_user_academic_record_application`
(
    `id`
),
...
(
    ...
    `controlled_user_email` VARCHAR
(
    255
) NOT NULL,
    `controlled_user_name` VARCHAR
(
    255
) NOT NULL,
    `controlled_user_student_id` VARCHAR
(
    255
) NOT NULL,
    `graduation_type` ENUM
...
(
    ...
    `target_academic_record_request_status` ENUM
(
    'ACCEPT',
    'REJECT',
    'AWAIT',
    ...
    `prior_academic_record_application_id` ENUM
(
    'ENROLLED',
    'LEAVE_OF_ABSENCE',
    'GRADUATED',
...
(
    ...
    `target_user_student_id` VARCHAR
(
    255
) NOT NULL,
    PRIMARY KEY
...
(
    ...
    `user_academic_record_log_id` VARCHAR
(
    255
) NOT NULL,
    `uuid_file_id` VARCHAR
...
(
    ...
    INDEX `idx_user_academic_record_log_attach_image_log_id`
(
    `user_academic_record_log_id`
    ASC
) VISIBLE,
    INDEX `idx_user_academic_record_log_attach_image_uuid_file_id`
(
    `uuid_file_id`
    ASC
) VISIBLE,
...
(
    ...
    REFERENCES `tb_user_academic_record_log`
(
    `id`
),
...
(
    ...
    UNIQUE INDEX `UK_5c0j7cyx9b1awc3y5v8m8t25e`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `UK_8yfr48oo34p9gkbl0ro62dxcx`
(
    `uuid_file_id`
    ASC
) VISIBLE,
    INDEX `idx_user_admission_attach_image__admission_id`
(
    `user_admission_id`
    ASC
) VISIBLE,
    INDEX `idx_user_admission_attach_image_uuid_file_id`
(
    `uuid_file_id`
    ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `UK_q92p8k87vpukt4uxceu54t98l`
(
    `uuid_file_id`
    ASC
) VISIBLE,
    INDEX `idx_user_admission_log_attach_image_log_id`
(
    `user_admission_log_id`
    ASC
) VISIBLE,
    INDEX `idx_user_admission_log_attach_image_uuid_file_id`
(
    `uuid_file_id`
    ASC
) VISIBLE,
...
(
    ...
    REFERENCES `tb_user_admission_log`
(
    `id`
))
    ENGINE = InnoDB
...
(
    ...
    INDEX `FKm3w9ve1mqdvu5yya43lgktqka`
(
    `board_id`
    ASC
) VISIBLE,
    INDEX `FKps9i1rpnulrnluj7m6fl212x`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FKsmjykxko0wkguyduujxljy9p1`
(
    `comment_id`
    ASC
) VISIBLE,
    INDEX `FKhtvmhbqf9n7whwlkpvakadg1x`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    `council_fee_fake_user_id` VARCHAR
(
    255
) NULL DEFAULT NULL,
    `user_id` VARCHAR
...
(
    ...
    UNIQUE INDEX `UK_gnokg5xtbxsb61hft4a2g8eng`
(
    `council_fee_fake_user_id`
    ASC
) VISIBLE,
    UNIQUE INDEX `UK_4hbj83xu0pmbq16nmj3q9kk3a`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    REFERENCES `tb_council_fee_fake_user`
(
    `id`
))
    ENGINE = InnoDB
...
(
    ...
    `target_is_joined_service` BIT
(
    1
) NOT NULL,
    `target_is_refunded` BIT
(
    1
) NOT NULL,
...
(
    ...
    `fcm_token_value` VARCHAR
(
    255
) NULL DEFAULT NULL,
    INDEX `FK67eb8vcoda8mx5odsy07fc1fh`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FK7sqkcrntbyp1x61eqmio1bp1e`
(
    `post_id`
    ASC
) VISIBLE,
    INDEX `FKlny56nrqcq87bftis6i91x2y7`
(
    `user_id`
    ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `UK_pp99y4eo5m8f7k0o6lecshsps`
(
    `user_id`
    ASC
) VISIBLE,
    UNIQUE INDEX `UK_ioi0qbw6h8fw1vqkssyxt8x7u`
(
    `uuid_file_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `idx_user_profile_uuid_file_id`
(
    `uuid_file_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FKnni9i6g97ug9egsfw6n01titi`
(
    `vote_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `FKj1rlo6wtl6qibjq8an1qj0ucl`
(
    `user_id`
    ASC
) VISIBLE,
    INDEX `FK6nwktkmc5plj4grvt2999fxcg`
(
    `vote_option_id`
    ASC
) VISIBLE,
