...
@DisplayName("CrawledNoticePublishFacade 테스트")
class CrawledNoticePublishFacadeTest {
	...
	void publishPendingNotices_delegatesPendingNoticesToService() {
		// given
	...
	void publishPendingNotices_continuesWhenOneNoticeTransferFails() {
		// given
