...
public class AuthServiceTest {
    ...
    class RegisterEmailUserTest {
        ...
        class RegisterFailTest {
            ...
            class UserAlreadyExist {
                ...
                @EnumSource(value = UserErrorCode.class, names = {"ALREADY_REGISTERED", "USER_DROPPED", "USER_INACTIVE_CAN_REJOIN"})
    ...
    class LoginEmailUserTest {
        ...
        void success() {
            ...
            verify(redisUtils).setRefreshTokenData(eq(REFRESH_TOKEN), eq(user.getId()), eq(StaticValue.JWT_REFRESH_TOKEN_VALID_TIME));
        }
