...
public class MessageUtil {
	...
	public static final String DEPARTMENT_EXPLICITLY_REQUIRED = "21학번 이후 입학생은 입학년도로 학과/학부를 결정할 수 없습니다. 학과/학부를 반드시 선택해주세요.";
	public static final String INVALID_ADMISSION_YEAR = "유효하지 않은 입학년도입니다.";
