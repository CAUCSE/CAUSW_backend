package net.causw.application.redis.auth;
...
public class AuthRedisService {
    ...
    * Value: "BLACKLISTED"
    ...
    public void addToBlacklist(String token) {
        ...
        authRedisTemplate.opsForValue().set(redisKey, "BLACKLISTED", StaticValue.JWT_ACCESS_TOKEN_VALID_TIME, TimeUnit.SECONDS);
    }
