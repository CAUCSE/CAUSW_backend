package net.causw.config.batch.jobConfig;

import lombok.RequiredArgsConstructor;
import net.causw.application.uuidFile.CleanUnusedUuidFileService;
import net.causw.config.batch.listener.CheckMeasureStepListener;
import net.causw.config.batch.listener.DeleteFileStepListener;
import net.causw.config.batch.listener.DeleteUnusedFileJobCompletionNotificationListener;
...
public class CleanUnusedUuidFilesBatchConfig {
    ...
    @Bean
    public Step initIsUsedUuidFileIntegrationStep(JobRepository jobRepository, PlatformTransactionManager transactionManager,
        ...
        return new StepBuilder("initIsUsedUuidFileIntegrationStep", jobRepository)
                .tasklet((contribution, chunkContext) -> {
                    cleanUnusedUuidFileService.initIsUsedUuidFileIntegration(chunkContext.getStepContext().getStepExecution());
    ...
    @Bean
    public Step checkIsUsedWithCalendarAttachImageIntegrationStep(JobRepository jobRepository, PlatformTransactionManager transactionManager,
                                                                  CheckMeasureStepListener checkMeasureStepListener) {
        return new StepBuilder("checkIsUsedWithCalendarAttachImageIntegrationStep", jobRepository)
                .tasklet((contribution, chunkContext) -> {
                    cleanUnusedUuidFileService.checkIsUsedWithCalendarAttachImageIntegration(chunkContext.getStepContext().getStepExecution());
                    return RepeatStatus.FINISHED;
                }, transactionManager)
                .listener(checkMeasureStepListener)
                .build();
    ...
    @Bean
    public Step checkIsUsedWithCircleMainImageIntegrationStep(JobRepository jobRepository, PlatformTransactionManager transactionManager,
                                                              CheckMeasureStepListener checkMeasureStepListener) {
        return new StepBuilder("checkIsUsedWithCircleMainImageIntegrationStep", jobRepository)
                .tasklet((contribution, chunkContext) -> {
                    cleanUnusedUuidFileService.checkIsUsedWithCircleMainImageIntegration(chunkContext.getStepContext().getStepExecution());
                    return RepeatStatus.FINISHED;
                }, transactionManager)
                .listener(checkMeasureStepListener)
                .build();
    ...
    @Bean
    public Step checkIsUsedWithEventAttachImageIntegrationStep(JobRepository jobRepository, PlatformTransactionManager transactionManager,
                                                               CheckMeasureStepListener checkMeasureStepListener) {
        return new StepBuilder("checkIsUsedWithEventAttachImageIntegrationStep", jobRepository)
                .tasklet((contribution, chunkContext) -> {
                    cleanUnusedUuidFileService.checkIsUsedWithEventAttachImageIntegration(chunkContext.getStepContext().getStepExecution());
                    return RepeatStatus.FINISHED;
                }, transactionManager)
                .listener(checkMeasureStepListener)
                .build();
    ...
    @Bean
    public Step checkIsUsedWithPostAttachImageIntegrationStep(JobRepository jobRepository, PlatformTransactionManager transactionManager,
                                                              CheckMeasureStepListener checkMeasureStepListener) {
        return new StepBuilder("checkIsUsedWithPostAttachImageIntegrationStep", jobRepository)
                .tasklet((contribution, chunkContext) -> {
                    cleanUnusedUuidFileService.checkIsUsedWithPostAttachImageIntegration(chunkContext.getStepContext().getStepExecution());
                    return RepeatStatus.FINISHED;
                }, transactionManager)
                .listener(checkMeasureStepListener)
                .build();
    ...
    @Bean
    public Step checkIsUsedWithUserAcademicRecordApplicationAttachImageIntegrationStep(JobRepository jobRepository, PlatformTransactionManager transactionManager,
                                                                                       CheckMeasureStepListener checkMeasureStepListener) {
        return new StepBuilder("checkIsUsedWithUserAcademicRecordApplicationAttachImageIntegrationStep", jobRepository)
                .tasklet((contribution, chunkContext) -> {
                    cleanUnusedUuidFileService.checkIsUsedWithUserAcademicRecordApplicationAttachImageIntegration(chunkContext.getStepContext().getStepExecution());
                    return RepeatStatus.FINISHED;
                }, transactionManager)
                .listener(checkMeasureStepListener)
                .build();
    ...
    @Bean
    public Step checkIsUsedWithUserAdmissionAttachImageIntegrationStep(JobRepository jobRepository, PlatformTransactionManager transactionManager,
                                                                       CheckMeasureStepListener checkMeasureStepListener) {
        return new StepBuilder("checkIsUsedWithUserAdmissionAttachImageIntegrationStep", jobRepository)
                .tasklet((contribution, chunkContext) -> {
                    cleanUnusedUuidFileService.checkIsUsedWithUserAdmissionAttachImageIntegration(chunkContext.getStepContext().getStepExecution());
                    return RepeatStatus.FINISHED;
                }, transactionManager)
                .listener(checkMeasureStepListener)
                .build();
    ...
    @Bean
    public Step checkIsUsedWithUserAdmissionLogAttachImageIntegrationStep(JobRepository jobRepository, PlatformTransactionManager transactionManager,
                                                                          CheckMeasureStepListener checkMeasureStepListener) {
        return new StepBuilder("checkIsUsedWithUserAdmissionLogAttachImageIntegrationStep", jobRepository)
                .tasklet((contribution, chunkContext) -> {
                    cleanUnusedUuidFileService.checkIsUsedWithUserAdmissionLogAttachImageIntegration(chunkContext.getStepContext().getStepExecution());
                    return RepeatStatus.FINISHED;
                }, transactionManager)
                .listener(checkMeasureStepListener)
                .build();
    ...
    @Bean Step checkIsUsedWithUserProfileImageIntegrationStep(JobRepository jobRepository, PlatformTransactionManager transactionManager,
                                                              CheckMeasureStepListener checkMeasureStepListener) {
        return new StepBuilder("checkIsUsedWithUserProfileImageIntegrationStep", jobRepository)
                .tasklet((contribution, chunkContext) -> {
                    cleanUnusedUuidFileService.checkIsUsedWithUserProfileImageIntegration(chunkContext.getStepContext().getStepExecution());
                    return RepeatStatus.FINISHED;
                }, transactionManager)
                .listener(checkMeasureStepListener)
                .build();
    ...
    @Bean Step deleteFileNotUsedStep(JobRepository jobRepository, PlatformTransactionManager transactionManager,
