...
public class CircleController {
    ...
    public CircleResponseDto create(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "동아리 생성 정보", required = true, content = @Content(schema = @Schema(implementation = CircleCreateRequestDto.class)))
     ...
     * @return CircleMemberResponseDto
     */
    @PutMapping(value = "/some-path/{circleId}/users/leave")
    @ResponseStatus(HttpStatus.OK)
    @Operation(
            summary = "동아리 탈퇴 API",
