...
public class ChatController {
    ...
    public ResponseEntity<ChatMessageDto.FirstMessageResponse> sendFirstOneToOneMessage(
        ...
        return ResponseEntity.ok(chatFacadeService.sendFirstOneToOneMessage(request, messageFiles, userDetails.getUser()));
    }
    ...
    public ResponseEntity<ChatMessageDto.MessagePageResponse> getMessages(
            ...
            Principal principal) {
        return ResponseEntity.ok(chatFacadeService.getMessagesWithParticipants(roomId, beforeTimestamp, limit, principal.getName()));
    }
