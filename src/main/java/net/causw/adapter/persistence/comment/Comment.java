...
public class Comment extends BaseEntity {
    ...
    public static Comment of(String content, Boolean isDeleted, Boolean isAnoymous, User writer, Post post) {
        return new Comment(content, isDeleted, isAnoymous, writer, post, new ArrayList<>());
    }
